      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-12 md:gap-16 lg:gap-20 items-center mt-12 sm:mt-16 md:mt-20">
          ...
          <div className="space-y-6 sm:space-y-7 md:space-y-8 order-1 md:order-2">
            <h2 className="text-2xl sm:text-3xl md:text-4xl text-blue-900 leading-tight font-semibold" style={{ fontFamily: "'Spartan', sans-serif" }}>
        ...
        <div className="text-center mt-12 sm:mt-14 md:mt-16">
          <div className="text-xl sm:text-2xl md:text-3xl text-purple-600 leading-relaxed font-semibold w-full max-w-[95%] sm:max-w-[90%] md:max-w-[85%] lg:max-w-[80%] mx-auto px-4" style={{ fontFamily: "'Spartan', sans-serif" }}>
