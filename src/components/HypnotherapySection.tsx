...
export function HypnotherapySection() {
  return (
    ...
    >
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 relative z-[2] w-full py-12 sm:py-16 md:py-20 lg:py-24" style={{ marginTop: '0', paddingTop: '45vh' }}>
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white mb-4 sm:mb-6 font-semibold" style={{ fontFamily: "'Spartan', sans-serif" }}>
            Scientific Evidence of Hypnotherapy
          </h2>
          
          <p className="text-lg sm:text-xl md:text-2xl text-white mb-8 sm:mb-10 md:mb-12 font-semibold" style={{ fontFamily: "'Spartan', sans-serif" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 md:gap-x-12 lg:gap-x-16 gap-y-6 sm:gap-y-8 max-w-6xl mx-auto mb-8 sm:mb-10 md:mb-12">
          {/* Left column */}
          <div className="space-y-4 sm:space-y-5 text-white leading-relaxed font-semibold text-sm sm:text-base md:text-lg" >
            <p>
