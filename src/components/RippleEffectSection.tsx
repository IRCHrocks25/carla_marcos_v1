    ...
    <section className="relative py-12 sm:py-16 md:py-20 lg:py-24 overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 items-center">
          ...
          {/* Right - Content */}
          <div className="text-white space-y-4 sm:space-y-5 md:space-y-6 order-1 md:order-2">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl mb-4 sm:mb-5 md:mb-6 lg:mb-8 font-bold">
              My Unique Edge
            </h2>
            ...
            <div className="mt-6 sm:mt-8 md:mt-10">
              <h3 className="text-lg sm:text-xl md:text-2xl mb-3 sm:mb-4 font-bold">
                My mantra:
              </h3>
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent italic leading-relaxed font-bold">
